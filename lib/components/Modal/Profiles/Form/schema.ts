  ...
  ssh: {
    ...
    ports: {
      ...
      inputs: [
        ...
        { key: 'dstHost', label: 'Forward Host', type: 'text' },
        { key: 'dstPort', label: 'Forward Port', type: 'number' },
      ],
      value: {
        local: {
          type: 'local',
        ...
        dynamic: { type: 'dynamic', host: '127.0.0.1', port: 1080 },
      },
  ...
  serial: {
    ...
    advanced: [
      ...
      },
      {
        key: 'parity',
        label: 'Parity',
        description: 'Bit used to check data integrity during transmission.',
        type: 'selector',
